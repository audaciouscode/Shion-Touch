//
//  FullSiteViewController.m
//  Shion Touch
//
//  Created by Chris Karr on 5/3/10.
...
@implementation FullSiteViewController
...
{
	if (section == 0)
		return [[[ApplicationModel sharedModel] devicesForSite:self.site] count];
	else if (section == 1)
		return [[[ApplicationModel sharedModel] snapshotsAtSite:self.site] count];
	else
		return [[[ApplicationModel sharedModel] triggersAtSite:self.site] count];
}

- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath 
{
    static NSString * CellIdentifier = @"FullSiteCell";
	...
	{
		NSArray * devices = [[ApplicationModel sharedModel] devicesForSite:self.site];
	...
	{
		NSArray * snapshots = [[ApplicationModel sharedModel] snapshotsAtSite:self.site];
	...
	{
		NSArray * triggers = [[ApplicationModel sharedModel] triggersAtSite:self.site];
