...
{
    static NSString * CellIdentifier = @"SnapshotSiteCell";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath 
{
	...
	Snapshot * snapshot = [[[ApplicationModel sharedModel] snapshotsAtSite:self.site] objectAtIndex:[indexPath indexAtPosition:([indexPath length] - 1)]];
